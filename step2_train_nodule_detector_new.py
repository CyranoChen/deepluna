...
#                cube_image = load_cube_img(record_item[0], 8, 8, 64)
                ...
                #   the nodule always should be the center of the cube
...
#    plot_model(model, to_file='step2_train_nodule_detector_new.png', show_shapes=True)
...
#    if True:
        ...
        train(train_full_set=True, load_weights_path=None, model_name="final_nodia", fold_count=-1, manual_labels=False)
